var main = function() {
  ...
  var init = function() {
    ...
    var torus = function() {
      ...
      buffers.torusCoords.pointCount = surface.points().byteLength / 12;
      return surface;
    }();
    ...
    var sphere = function() {
      ...
      gl.bufferData(gl.ARRAY_BUFFER, surface.points(), gl.STATIC_DRAW);
      buffers.sphereCoords.pointCount = surface.points().byteLength / 12;
      return surface;
    }();
  ...
  var draw = function(currentTime) {
    ...
    // gl.drawElements(gl.POINTS, 2 * buffers.wireframe.lineCount, gl.UNSIGNED_SHORT, 0)
    gl.drawArrays(gl.POINTS, 0, buffers.sphereCoords.pointCount)
    ...
    gl.vertexAttribPointer(attribs.POSITION, 3, gl.FLOAT, false, 12, 0);
    gl.drawElements(gl.POINTS, 2 * buffers.wireframe.lineCount, gl.UNSIGNED_SHORT, 0)
    // gl.drawArrays(gl.POINTS, 0, buffers.torusCoords.pointCount)
